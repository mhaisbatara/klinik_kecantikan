...
--
-- Host: localhost:3306
-- Generation Time: Aug 21, 2026 at 03:48 AM
...
(36, '1f97898c1bbd1001b13f84a00cc897700e03da3761acc607790d92753a25c5fa11fd436902cf48d8', 'USR000000', '0', '2026-08-28 03:10:46', NULL);
...
(2, 'KAT-002', 'Perawatan Kulit', 'Treatment kesehatan dan peremajaan kulit', 'aktif', 'Asia/Jakarta', 'superadmin@admin.com', '2026-08-20 05:55:00', 'superadmin@admin.com', '2026-08-20 20:02:34'),
(3, 'KAT-003', 'Perawatan Rambut', 'Layanan terapi scalp dan nutrisi rambut', 'aktif', 'Asia/Jakarta', 'superadmin@admin.com', '2026-08-20 06:00:15', 'superadmin@admin.com', '2026-08-20 20:11:39'),
...
(5, 'KAT-005', 'Anti Aging', 'Terapi khusus penuaan dini dan kerutan', 'aktif', 'Asia/Jakarta', 'superadmin@admin.com', '2026-08-20 06:15:30', 'superadmin@admin.com', '2026-08-20 20:11:46');
...
CREATE TABLE `trx_antrian_layanan` (
  ...
  `jenis_layanan` enum('layanan','paket') NOT NULL DEFAULT 'layanan',
  `kode_layanan` varchar(20) NOT NULL,
  `nomor_antrian` varchar(10) NOT NULL,
...
INSERT INTO `trx_antrian_layanan` (`id`, `kode_antrian_layanan`, `kode_kunjungan`, `jenis_layanan`, `kode_layanan`, `nomor_antrian`, `status`, `dipanggil_at`, `selesai_at`, `tz`, `created_by`, `created_at`, `updated_by`, `updated_at`) VALUES
(5, 'AL-20260820-001', 'KJ-20260820-001', 'layanan', 'LAY-005', '01', 'batal', '2026-08-20 08:01:16', NULL, 'Asia/Jakarta', 'superadmin@admin.com', '2026-08-20 07:46:41', 'superadmin@admin.com', '2026-08-20 08:30:51');
