...
export const TabKunjunganHariIni: React.FC<Props> = ({ toast, refreshTrigger }) => {
  ...
  // Auto-polling interval (8 seconds)
  useEffect(() => {
      ...
      >
        <div className="confirmation-content flex align-items-center gap-3">
          ...
          {selectedKunjunganBatal && (
            <span>
              Apakah Anda yakin ingin membatalkan kunjungan <b>{selectedKunjunganBatal.kode_kunjungan}</b> atas nama pasien <b>{selectedKunjunganBatal.nama_pasien}</b>? Data antrean akan diubah menjadi batal tanpa menghapus record.
            </span>
          )}
        </div>
      </Dialog>
