export const apiEndpointData = '/master/antrian-awal-data';
export const apiEndpointCreate = '/master/antrian-awal-create';
export const apiEndpointUpdate = '/master/antrian-awal-update';
