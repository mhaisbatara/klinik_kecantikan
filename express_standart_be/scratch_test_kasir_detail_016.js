...
async function testKasirDetail016() {
  try {
    const kode_transaksi = "TRX-20260831-016";
    ...
    console.log("Kasir Detail API output for TRX-20260831-016:");
    console.log(JSON.stringify(detailsMapped, null, 2));
