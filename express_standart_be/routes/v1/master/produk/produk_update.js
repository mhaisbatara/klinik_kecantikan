...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    await DB.transaction(async (trx) => {
      ...
      const oData = { kode_kategori_produk: oPayload.kode_kategori_produk, kode_supplier: oPayload.kode_supplier || null, nama: oPayload.nama, satuan: oPayload.satuan, harga_beli: oPayload.harga_beli, harga_jual: oPayload.harga_jual, stok_minimum: oPayload.stok_minimum, status: oPayload.status, updated_by: username, updated_at: formatDateSystem() };
