...
async function testKasirDetail013() {
  try {
    const kode_transaksi = "TRX-20260831-013";
    ...
    console.log("TRX-20260831-013 Summary:");
    console.log("Header Total Bayar:", trx.total_bayar);
    console.log("is_product_only:", trx.is_product_only);
